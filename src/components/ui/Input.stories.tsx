...
const meta: Meta<typeof Input> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Componente Input para captura de datos de texto. Soporta etiquetas, iconos, estados de error y múltiples tamaños.',
      },
    },
  },
};
...
export const StatesShowcase: Story = {
  render: () => (
    <div className="flex flex-col gap-4 max-w-sm">
      ...
      <Input label="Con helper" placeholder="Input con ayuda" helperText="Texto de ayuda adicional" />
      <Input label="Con error" placeholder="Input con error" error="Este campo es requerido" />
