...
const PermissionsScreen: React.FC<PermissionsScreenProps> = ({ onAccept, onGoHome }) => {
  ...
  return (
    <div className="min-h-full flex items-center justify-center px-4 py-8 pt-safe pb-safe overflow-y-auto">
      <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-bocado w-full max-w-sm animate-fade-in my-auto">
        {/* Header */}
