    ...
    <div className="space-y-4 animate-fade-in">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2 max-w-[320px] mx-auto sm:mx-0">
            {[
              {
                value: "Mujer",
                label: t("step1.genderFemale"),
                testId: "gender-female",
                icon: <FemaleIcon className="w-4 h-4" />,
              },
              {
                value: "Hombre",
                label: t("step1.genderMale"),
                testId: "gender-male",
                icon: <MaleIcon className="w-4 h-4" />,
              },
              {
                value: "Otro",
                label: t("step1.genderOther"),
                testId: "gender-other",
                icon: <OtherGenderIcon className="w-4 h-4" />,
              },
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative">
              ...
              />
              <span className="absolute right-2 top-1/2 -translate-y-1/2 text-2xs text-bocado-gray font-medium">
                {t("step1.weightUnit")}
              </span>
            </div>
          </div>
      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          {cityOptions.length > 0 && (
            <div
              className="absolute z-50 w-full mt-1 bg-white border border-bocado-border rounded-xl shadow-bocado max-h-40 overflow-y-auto"
              role="listbox"
              aria-label={t("step1.citySuggestions")}
            >
              {cityOptions.map((city, idx) => (
                ...
                >
                  ...
                  <span className="text-bocado-gray text-2xs">
                    {city.secondaryText}
                  </span>
                </button>
              ))}
      ...
      <div className="relative">
        ...
        {showEmailSuggestions && emailSuggestions.length > 0 && (
          <div
            className="absolute z-10 w-full mt-1 bg-white border border-bocado-border rounded-xl shadow-bocado overflow-hidden"
            role="listbox"
            aria-label={t("step1.emailSuggestions")}
          >
