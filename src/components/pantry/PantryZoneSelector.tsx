...
export const PantryZoneSelector: React.FC<PantryZoneSelectorProps> = ({
  ...
  return (
    <div className="flex-1 px-4 pt-4 pb-24 min-h-0">
      ...
      <p className="text-center text-bocado-gray text-sm mb-6">
        {t("pantry.subtitle")}
      </p>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-bold text-bocado-text">
                  {translateZone(zone)}
                </span>
              </div>
      ...
      {urgentItems.length > 0 && (
        <div className="mt-6 bg-white border border-red-100 rounded-2xl p-3 shadow-bocado">
          <div className="flex items-center gap-2 mb-2 border-b border-red-50 pb-2">
            ...
            <h3 className="text-2xs font-bold text-red-500 uppercase tracking-wide">
              {t("pantry.urgentTitle")}
            </h3>
          </div>
