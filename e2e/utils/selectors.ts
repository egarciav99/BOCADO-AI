...
export const SELECTORS = {
  ...
  register: {
    ...
    passwordInput:
      'input[name="password"], input[type="password"]:first-of-type',
    confirmPasswordInput:
      'input[name="confirmPassword"], input[name="confirm-password"], input[placeholder*="confirmar" i]',
    ...
    genderMale:
      'input[value="male"], [data-testid="gender-male"], button:has-text("Hombre")',
    genderFemale:
      'input[value="female"], [data-testid="gender-female"], button:has-text("Mujer")',
    genderOther:
      'input[value="other"], [data-testid="gender-other"], button:has-text("Otro")',
    ...
    activityLevelSelect:
      'select[name="activityLevel"], [data-testid="activity-level"]',
    ...
    intolerancesInput:
      'input[name="intolerances"], input[placeholder*="intolerancia" i]',
  ...
  recommendation: {
    ...
    homeOption:
      'button:has-text("En casa"), [data-testid="location-home"], div:has-text("En casa")',
    outsideOption:
      'button:has-text("Fuera"), [data-testid="location-outside"], div:has-text("Fuera")',

    // Tipo de comida
    mealTypeBreakfast:
      'button:has-text("Desayuno"), [data-testid="meal-breakfast"]',
    mealTypeLunch:
      'button:has-text("Almuerzo"), [data-testid="meal-lunch"], button:has-text("Comida")',
    mealTypeDinner: 'button:has-text("Cena"), [data-testid="meal-dinner"]',
    mealTypeSnack:
      'button:has-text("Snack"), [data-testid="meal-snack"], button:has-text("Merienda")',

    // Botón de generar
    generateButton:
      'button:has-text("Generar"), [data-testid="generate-recommendation"], button:has-text("Crear")',

    // Resultados
    recommendationResult:
      '[data-testid="recommendation-result"], .recommendation-result',
    ...
    // Acciones
    saveRecipeButton:
      'button:has-text("Guardar"), [data-testid="save-recipe"], button[aria-label*="guardar" i]',
    shareButton: 'button:has-text("Compartir"), [data-testid="share-recipe"]',
    regenerateButton:
      'button:has-text("Regenerar"), button:has-text("Otra opción")',
  },
  ...
  bottomNav: {
    ...
    recommendation:
      '[data-testid="nav-recommendation"], button:has-text("Inicio")',
  ...
  profile: {
    ...
    deleteAccountButton:
      'button:has-text("Eliminar cuenta"), [data-testid="delete-account"]',
  ...
  pantry: {
    addItemButton:
      'button:has-text("Añadir"), [data-testid="add-item"], button[aria-label*="añadir" i]',
    ...
    deleteItemButton:
      'button[aria-label*="eliminar" i], button:has-text("Eliminar")',
  },
  ...
  plan: {
    ...
    generatePlanButton:
      'button:has-text("Generar plan"), [data-testid="generate-plan"]',
  },
  ...
  modal: {
    ...
    closeButton:
      'button[aria-label*="cerrar" i], [data-testid="close-modal"], button:has-text("×")',
