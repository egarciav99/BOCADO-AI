...
test.describe("Ejemplo usando Fixtures", () => {
   ...
   */
  test("usuario autenticado puede generar recomendación", async ({
    page,
    authenticatedUser,
  }) => {
   ...
   */
  test("puede actualizar perfil y limpiar automáticamente", async ({
    page,
    authenticatedPage,
  }) => {
   ...
   */
  test("flujo completo de registro a primera recomendación", async ({
    page,
  }) => {
